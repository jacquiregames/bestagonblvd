...
TilesC = {
  'APARTMENTS': HexTile(
    ...
    key='apartments',
    name='Apartments',
    image='assets/tiles/C/apartments.png',
  ...
  'BED_AND_BREAKFAST': HexTile(
    ...
    name='Bed & Breakfast',
    image='assets/tiles/C/bed_and_breakfast.png',
    category=TileCategory.RESIDENTIAL,
    type=None,
    cost=9,
    incomeChange=0,
  ...
  'BOUTIQUE': HexTile(
    ...
    key='boutique',
    name='Boutique',
    image='assets/tiles/C/boutique.png',
  ...
  'CHIP_FABRICATION_PLANT': HexTile(
    ...
    image='assets/tiles/C/chip_fabrication_plant.png',
  ...
  'CONDOMINIUM': HexTile(
    ...
    key='condominium',
    name='Condominium',
    image='assets/tiles/C/condominium.png',
    category=TileCategory.RESIDENTIAL,
    type=None,
    cost=14,
    incomeChange=0,
  ...
  'HIGH_SCHOOL': HexTile(
    ...
    key='high_school',
    name='High School',
    image='assets/tiles/C/high_school.png',
  ...
  'HOTEL': HexTile(
    ...
    key='hotel',
    name='Hotel',
    image='assets/tiles/C/hotel.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=13,
    incomeChange=1,
  ...
  'INTERNATIONAL_AIRPORT': HexTile(
    ...
    image='assets/tiles/C/international_airport.png',
    category=TileCategory.INDUSTRIAL,
  ...
  'LOCAL_EPA_OFFICE': HexTile(
    ...
    image='assets/tiles/C/local_epa_office.png',
    category=TileCategory.CIVIC,
  ...
  'MIDDLE_SCHOOL': HexTile(
    ...
    key='middle_school',
    name='Middle School',
    image='assets/tiles/C/middle_school.png',
    category=TileCategory.CIVIC,
    type=TileType.SCHOOL,
    cost=10,
    incomeChange=0,
  ...
  'NEW_CAR_DEALERSHIP': HexTile(
    ...
    image='assets/tiles/C/new_car_dealership.png',
    category=TileCategory.COMMERCIAL,
  ...
  'ONE_MORE_ROUND': HexTile(
    ...
    key='one_more_round',
    name='One More Round',
    image='assets/tiles/C/one_more_round.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=0,
    incomeChange=0,
  ...
  'PR_FIRM': HexTile(
    ...
    key='pr_firm',
    name='PR Firm',
    image='assets/tiles/C/pr_firm.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=20,
    incomeChange=-2,
  ...
  'RECYCLING_PLANT': HexTile(
    ...
    image='assets/tiles/C/recycling_plant.png',
    category=TileCategory.INDUSTRIAL,
    type=None,
    cost=17,
    incomeChange=0,
  ...
  'RESORT': HexTile(
    ...
    key='resort',
    name='Resort',
    image='assets/tiles/C/resort.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=16,
    incomeChange=1,
  ...
  'UNIVERSITY': HexTile(
    ...
    key='university',
    name='University',
    image='assets/tiles/C/university.png',
    category=TileCategory.CIVIC,
    type=None,
    cost=15,
    incomeChange=2,

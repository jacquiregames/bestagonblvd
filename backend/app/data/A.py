...
TilesA = {
  ...
  'WATERFRONT_REALTY': HexTile(
    ...
    reputationChange=0, 
    effects=[],  
    description='Take $2 for each tile already adjacent to any of your Lakes. Tiles placed adjacent to your Lakes now yield a $4 bonus instead of $2. (With investment: $6).',
    limit=2,
    isUnique=False,
    set='Base'
  ),

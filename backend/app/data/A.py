...
TilesA = {
  'BUSINESS_SUPPLY_STORE': HexTile(
    ...
    image='assets/tiles/A/business_supply_store.png',
  ...
  'CONVENIENCE_STORE': HexTile(
    ...
    image='assets/tiles/A/convenience_store.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=6,
    incomeChange=1,
  ...
  'FANCY_RESTAURANT': HexTile(
    ...
    image='assets/tiles/A/fancy_restaurant.png',
    category=TileCategory.COMMERCIAL,
  ...
  'FAST_FOOD_RESTAURANT': HexTile(
    ...
    image='assets/tiles/A/fast_food_restaurant.png',
    category=TileCategory.COMMERCIAL,
    type=TileType.RESTAURANT,
    cost=7,
    incomeChange=1,
  ...
  'FREEWAY': HexTile(
    ...
    key='freeway',
    name='Freeway',
    image='assets/tiles/A/freeway.png',
    category=TileCategory.INDUSTRIAL,
    type=None,
    cost=5,
    incomeChange=0,
  ...
  'HOMEOWNERS_ASSOCIATION': HexTile(
    ...
    image='assets/tiles/A/homeowners_association.png',
  ...
  'LANDFILL': HexTile(
    ...
    key='landfill',
    name='Landfill',
    image='assets/tiles/A/landfill.png',
    category=TileCategory.INDUSTRIAL,
    type=None,
    cost=4,
    incomeChange=2,
  ...
  'MOBILE_HOME_COMMUNITY': HexTile(
    ...
    image='assets/tiles/A/mobile_home_community.png',
    category=TileCategory.RESIDENTIAL,
    type=None,
    cost=4,
    incomeChange=0,
  ...
  'MUNICIPAL_AIRPORT': HexTile(
    ...
    image='assets/tiles/A/municipal_airport.png',
    category=TileCategory.INDUSTRIAL,
  ...
  'OFFICE_BUILDING': HexTile(
    ...
    image='assets/tiles/A/office_building.png',
    category=TileCategory.COMMERCIAL,
  ...
  'PARKING_LOT': HexTile(
    ...
    key='parking_lot',
    name='Parking Lot',
    image='assets/tiles/A/parking_lot.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=12,
    incomeChange=1,
  ...
  'SLAUGHTERHOUSE': HexTile(
    ...
    key='slaughterhouse',
    name='Slaughterhouse',
    image='assets/tiles/A/slaughterhouse.png',
    category=TileCategory.INDUSTRIAL,
    type=None,
    cost=5,
    incomeChange=0,
  ...
  'WATERFRONT_REALTY': HexTile(
    ...
    image='assets/tiles/A/waterfront_realty.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=6,
    incomeChange=0,

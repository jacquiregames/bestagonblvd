...
TilesB = {
  'BURG_VON_ALSPACH': HexTile(
    ...
    image='assets/tiles/B/burg_von_alspach.png',
  ...
  'CASINO': HexTile(
    ...
    key='casino',
    name='Casino',
    image='assets/tiles/B/casino.png',
  ...
  'DOMESTIC_AIRPORT': HexTile(
    ...
    image='assets/tiles/B/domestic_airport.png',
  ...
  'ELEMENTARY_SCHOOL': HexTile(
    ...
    image='assets/tiles/B/elementary_school.png',
  ...
  'GAS_STATION': HexTile(
    ...
    key='gas_station',
    name='Gas Station',
    image='assets/tiles/B/gas_station.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=7,
    incomeChange=1,
  ...
  'HOSTEL': HexTile(
    ...
    key='hostel',
    name='Hostel',
    image='assets/tiles/B/hostel.png',
    category=TileCategory.RESIDENTIAL,
    type=None,
    cost=0,
    incomeChange=0,
  ...
  'HOUSING_PROJECTS': HexTile(
    ...
    image='assets/tiles/B/housing_projects.png',
    category=TileCategory.RESIDENTIAL,
    type=None,
    cost=8,
    incomeChange=0,
  ...
  'MOVIE_THEATER': HexTile(
    ...
    key='movie_theater',
    name='Movie Theater',
    image='assets/tiles/B/movie_theater.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=10,
    incomeChange=1,
  ...
  'MUSEUM': HexTile(
    ...
    key='museum',
    name='Museum',
    image='assets/tiles/B/museum.png',
    category=TileCategory.CIVIC,
    type=None,
    cost=8,
    incomeChange=0,
  ...
  'OFFICE_OF_BUREAUCRACY': HexTile(
    ...
    image='assets/tiles/B/office_of_bureaucracy.png',
    category=TileCategory.CIVIC,
  ...
  'POSTAL_SERVICE': HexTile(
    ...
    key='postal_service',
    name='Postal Service',
    image='assets/tiles/B/postal_service.png',
    category=TileCategory.CIVIC,
    type=None,
    cost=12,
    incomeChange=0,
  ...
  'POWER_STATION': HexTile(
    ...
    key='power_station',
    name='Power Station',
    image='assets/tiles/B/power_station.png',
    category=TileCategory.CIVIC,
    type=None,
    cost=11,
    incomeChange=0,
  ...
  'RETIREMENT_VILLAGE': HexTile(
    ...
    image='assets/tiles/B/retirement_village.png',
    category=TileCategory.RESIDENTIAL,
    type=None,
    cost=8,
    incomeChange=0,
  ...
  'SHIPPING_CENTER': HexTile(
    ...
    image='assets/tiles/B/shipping_center.png',
    category=TileCategory.COMMERCIAL,
    type=None,
    cost=16,
    incomeChange=1,
  ...
  'SKYSCRAPER': HexTile(
    ...
    key='skyscraper',
    name='Skyscraper',
    image='assets/tiles/B/skyscraper.png',
    category=TileCategory.COMMERCIAL,
  ...
  'STADIUM': HexTile(
    ...
    key='stadium',
    name='Stadium',
    image='assets/tiles/B/stadium.png',
    category=TileCategory.CIVIC,
    type=None,
    cost=16,
    incomeChange=1,
  ...
  'WAREHOUSE': HexTile(
    ...
    key='warehouse',
    name='Warehouse',
    image='assets/tiles/B/warehouse.png',
    category=TileCategory.INDUSTRIAL,
    type=None,
    cost=13,
    incomeChange=0,

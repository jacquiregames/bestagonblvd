...
GOALS = {
  'ACQUATIC_ENGINEER': Goal(
    id='ACQUATIC_ENGINEER', key='acquatic_engineer', name='Acquatic Engineer', image='assets/goals/acquatic_engineer.png',
  ...
  'AIR_TRAFFIC_CONTROLLER': Goal(
    id='AIR_TRAFFIC_CONTROLLER', key='air_traffic_controller', name='Air Traffic Controller', image='assets/goals/air_traffic_controller.png',
  ...
  'AQUAPHOBIAN': Goal(
    id='AQUAPHOBIAN', key='aquaphobian', name='Aquaphobian', image='assets/goals/aquaphobian.png',
    description='Fewest Lakes',
    condition=GoalCondition(type=GoalConditionType.FEWEST, target=GoalTarget.LAKE),
    populationBonus=20, set='Base'
  ),
  'BILLIONAIRE': Goal(
    id='BILLIONAIRE', key='billionaire', name='Billionaire', image='assets/goals/billionaire.png',
    description='Most Money',
    condition=GoalCondition(type=GoalConditionType.MOST, target=GoalTarget.MONEY),
    populationBonus=10, set='Base'
  ),
  'BUILDER': Goal(
    id='BUILDER', key='builder', name='Builder', image='assets/goals/builder.png',
  ...
  'PUBLIC_OFFICIAL': Goal(
    id='PUBLIC_OFFICIAL', key='public_official', name='Public Official', image='assets/goals/public_official.png',
    description='Most Contiguous Civic',
    condition=GoalCondition(type=GoalConditionType.MOST, target=GoalTarget.CONTIGUOUS_CIVIC),
    populationBonus=15, set='Base'
  ),  
  'SOCIALIST': Goal(
    id='SOCIALIST', key='socialist', name='Socialist', image='assets/goals/socialist.png',
    description='Fewest Commercial',
    condition=GoalCondition(type=GoalConditionType.FEWEST, target=GoalTarget.COMMERCIAL),
    populationBonus=10, set='Base'
  ),
  'SPENDTHRIFT': Goal(
    id='SPENDTHRIFT', key='spendthrift', name='Spendthrift', image='assets/goals/spendthrift.png',
